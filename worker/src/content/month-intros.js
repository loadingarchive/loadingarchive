...
export const MONTH_INTROS = {
  '2026-01': [
    `January eases the year in with indie volume rather than blockbusters, but there are real headliners hiding in the list. Riot's free-to-play fighting game <strong>2XKO</strong> finally launches on January 20, and Bandai Namco doubles down on soulslike action with <strong>Code Vein 2</strong> at the end of the month. The Switch 2 keeps absorbing last generation's best: Final Fantasy VII Remake Intergrade and Dynasty Warriors: Origins both arrive as ports on January 22 — check the badge and the original date before you treat them as new releases.`,
