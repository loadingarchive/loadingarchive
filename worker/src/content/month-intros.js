...
export const MONTH_INTROS = {
  ...
  '2026-05': [
    ...
    `The port column is unusually strong this month: Indiana Jones and the Great Circle and Stray both land on Switch 2, and Story of Seasons: Grand Bazaar reaches PS5 and Xbox. Thirteen re-releases in total, every one labeled with its original date. Lego Batman: Legacy of the Dark Knight (May 22) and Warhammer 40,000: Mechanicus II round out a denser month than its 220 entries suggest.`,
  ],
  '2026-06': [
